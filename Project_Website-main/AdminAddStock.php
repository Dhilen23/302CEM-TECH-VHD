...
if(isset($_POST['submit'])){
    ...
    $i="insert into itemtb(itemID,itemName,itemCat,itemIMG,itemSpec,itemDate)values('$n','$c','$b','$d','$img')";
...
<body><br><br>
    <header> 
        ...
        <ul>
            ...
            <li><a href="#" class="active">Add to Stock</a></li>
