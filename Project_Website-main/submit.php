            ...
            <div class="form-holder">
                <div class="form-content">
                    <div class="form-items">
                        <h3>Add your stocks here</h3>
                        <p>Fill in the data below.</p>
                        <form action="" method="post" enctype="multipart/form-data">

                            <div class="col-md-12">
                               <input class="form-control" type="text" name="barcode" placeholder="Item Barcode" required>
                           ...
                           <div class="col-md-12">
                              <input class="form-control" type="text" name="date" placeholder="Manufactured Date" required>
                           ...
                           <div class="col-md-12">
                                <input class="form-control" type="text" name="specs" placeholder="Specifications" required>
...
<div class="form-group">
    ...
    <textarea class="form-control" name="description" id="exampleFormControlTextarea1" placeholder="Sold/available" rows="3"></textarea>
